...
def plot_with_labels(low_dim_embs, labels, filename="tsen.png"):
...
if __name__ == '__main__':
    ...
    with graph.as_default():
        ...
        valid_embeddings = tf.nn.embedding_lookup(normalized_embeddings, vallid_dataset)
    ...
    with tf.Session(graph=graph) as session:
        ...
        for step in range(num_steps):
            batch_input, batch_labels = generate_batch(batch_size, num_skips, skip_window, data=data)
